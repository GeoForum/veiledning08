var bounds = [-80000, 6445000, 1120000, 7945000], // UTM 33N left, bottom, right, top
...
csv('data/nor2015pop_5kmruter.csv').get(function(error, data) { // ru250m_2015.csv
    for (var i = 0; i < data.length; i++) {
        var id = data[i].ru5000m, // ru250m
